...
@Entity
@Table(name = "attendance_email_outbox")
public class AttendanceEmailOutbox {
    ...
    @Column(name="attendance_id", nullable=false) private Long attendanceId;
    ...
    @PrePersist void prePersist(){ if(createdAt==null) createdAt=OffsetDateTime.now(); if(status==null) status="PENDING"; }
    ...
    public String getNotificationType(){return notificationType;} public void setNotificationType(String v){notificationType=v;} public Long getAttendanceId(){return attendanceId;} public void setAttendanceId(Long v){attendanceId=v;}
